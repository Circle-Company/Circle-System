...
export async function positive_interaction_rate(processed_interactions: any) {
    const interactions_vector = processed_interactions.processed_interactions.map((i) => {
        ...
        const interaction_with_weights = {
            ...
            click_into_moment:
                interaction.click_into_moment * positiveInteractionWeights.click_into_moment.weight,
            watch_time: interaction.watch_time * positiveInteractionWeights.watch_time.weight,
            click_profile:
                interaction.click_profile * positiveInteractionWeights.click_profile.weight,
            ...
            show_less_often:
                interaction.show_less_often * positiveInteractionWeights.show_less_often.weight,
...
export function calcule_one_positive_interaction_rate(processed_interaction: any): number {
    const interaction_with_weights = {
        ...
        click_into_moment:
            processed_interaction.click_into_moment *
            positiveInteractionWeights.click_into_moment.weight,
        watch_time: processed_interaction.watch_time * positiveInteractionWeights.watch_time.weight,
        click_profile:
            processed_interaction.click_profile * positiveInteractionWeights.click_profile.weight,
        comment: processed_interaction.comment * positiveInteractionWeights.comment.weight,
        like_comment:
            processed_interaction.like_comment * positiveInteractionWeights.like_comment.weight,
        pass_to_next:
            processed_interaction.pass_to_next * positiveInteractionWeights.pass_to_next.weight,
        show_less_often:
            processed_interaction.show_less_often *
            positiveInteractionWeights.show_less_often.weight,
...
export function calcule_one_negative_interaction_rate(processed_interaction: any): number {
    const interaction_with_weights = {
        ...
        click_into_moment:
            processed_interaction.click_into_moment *
            negativeInteractionWeights.click_into_moment.weight,
        watch_time: processed_interaction.watch_time * negativeInteractionWeights.watch_time.weight,
        click_profile:
            processed_interaction.click_profile * negativeInteractionWeights.click_profile.weight,
        comment: processed_interaction.comment * negativeInteractionWeights.comment.weight,
        like_comment:
            processed_interaction.like_comment * negativeInteractionWeights.like_comment.weight,
        pass_to_next:
            processed_interaction.pass_to_next * negativeInteractionWeights.pass_to_next.weight,
        show_less_often:
            processed_interaction.show_less_often *
            negativeInteractionWeights.show_less_often.weight,
