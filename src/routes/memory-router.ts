...
memoryRouter.delete(MEMORY_PREFIX + '/delete', MemoryController.DeleteMemory)
memoryRouter.delete(MEMORY_PREFIX + '/remove-moment', MemoryController.DeleteMemoryMoment)
